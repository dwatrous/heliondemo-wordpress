#!/bin/bash
# originally from https://github.com/Stackato-Apps/wordpress
FS=$STACKATO_FILESYSTEM

echo "Adapt WordPress to store wp-content and other modifiable files in a Helion filesystem service."
if [ -e $FS/wp-salt.php ]
  then
